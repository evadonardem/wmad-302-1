...
const colors = [
  ...
  "bg-gradient-to-br from-teal-50 to-teal-100 border-teal-200 text-teal-800",
              ...
              <div className="flex flex-col lg:flex-row gap-4 items-stretch">
                ...
                <div className="flex gap-3">
                  <Button
                    ...
                    className="h-12 px-6 bg-amber-500 hover:bg-amber-600 text-white flex items-center gap-2"
                    size="lg"
                  >
                  ...
                  <Button
                    ...
                    className="h-12 px-6 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white flex items-center gap-2"
                    size="lg"
                  >
