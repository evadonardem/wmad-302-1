...
export const PRODUCTS_PRICE_DESC = 'https://dummyjson.com/products?sortBy=price&order=desc';

export const PRODUCTS_DISCOUNT = 'https://dummyjson.com/products?sortBy=discountPercentage&order=desc';
